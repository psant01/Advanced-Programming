...
def listRemoveitem(listOfTasks, itemNameToRemove, CreationDate, DueDate):
    listOfTasks.remove([itemNameToRemove, CreationDate, DueDate])
    return listOfTasks
...
while(userChoice != "exit" or userChoice != "Exit"):
    ...
    if(userChoice == "1"):
        ...
        taskCreationDate = input("Please add a creation date: ")
        taskDueDate = input("Please add a due date: ")
        taskList = listRemoveitem(taskList,taskName, taskCreationDate, taskDueDate)
        
        print("The newly updated task list is: ")
        print(taskList) # Print updated task list
